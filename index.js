...
var util = require('util'),
  Repository = require('viewmodel/lib/base'),
  ViewModel = Repository.ViewModel,
  ConcurrencyError = require('viewmodel/lib/concurrencyError'),
...
_.extend(AzureTable.prototype, {
  ...
  get: function (id, callback) {
    ...
    var PartitionKey = self.options.getPartitionKey() || id;
    var RowKey = id;
